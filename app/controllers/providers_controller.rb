...
class ProvidersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @provider.save
        format.html { redirect_to providers_path, notice: 'Producto sido creado con éxito.' }
  ...
  def destroy
    @provider.destroy
    respond_to do |format|
      format.html { redirect_to providers_url, notice: 'Producto fue destruido con éxito.' }
